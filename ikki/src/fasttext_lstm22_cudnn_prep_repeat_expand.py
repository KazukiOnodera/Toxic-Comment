...
window_length = 750 # The amount of words we look at per example. Experiment with this.
...
def build_lstm_stack_model(logdir='attention'):
    ...
    inp_dr = Dropout(0.2)(inp)
    l_lstm = Bidirectional(CuDNNGRU(156, return_sequences=True))(inp_dr)
