...
"""
Create train/test dataset for ML
"""
split_index = round(len(train) * 0.9)
shuffled_train = train.sample(frac=1, random_state=407)
...
sample_submission.to_csv('../output/test_fasttext_val0.990713_0.003469.csv', index=False)
