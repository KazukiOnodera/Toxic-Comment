...
ensemble_name = 'rank_ensemble2_simple'
...
# val
val_pred_list = [
'tuned_xgb1_cv_oof_0.957144_0.002661.csv',
#'tuned_xgb2_cv_oof_0.953482_0.003482.csv',
'tuned_xgb3_cv_oof_0.953037_0.003267.csv',
'tuned_xgb4_cv_oof_0.956562_0.003344.csv',
'tuned_xgb5_cv_oof_0.956100_0.003366.csv'
]

rank_avg(val_pred_list, save_name='xgb')

# test
test_pred_list = [
'tuned_xgb1_cv_test.csv',
#'tuned_xgb2_cv_test.csv',
'tuned_xgb3_cv_test.csv',
'tuned_xgb4_cv_test.csv',
'tuned_xgb5_cv_test.csv'
]

rank_avg(test_pred_list, save_name='xgb', pred_type='test')
"""
Capule
"""
# val
...
rank_avg(val_pred_list, save_name='capsule')
...
rank_avg(test_pred_list, save_name='capsule', pred_type='test')
...
# val
val_pred_list = [
'rank_ensemble1_simple_lstm_oof_0.990797_0.002340.csv',
'rank_ensemble1_simple_logreg_oof_0.986189_0.004719.csv',
'rank_ensemble1_simple_capsule_oof_0.989169_0.002674.csv',

]

rank_avg(val_pred_list, save_name='lstm_logreg_capsule', weights=[5, 2, 3])

# test
test_pred_list = [
'rank_ensemble1_simple_lstm_test.csv',
'rank_ensemble1_simple_logreg_test.csv',
'rank_ensemble1_simple_capsule_test.csv',
]

rank_avg(test_pred_list, save_name='lstm_logreg_capsule', weights=[5, 2, 3], pred_type='test')
