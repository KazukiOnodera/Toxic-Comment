...
ensemble_name = 'rank_ensemble1_simple'
...
'rank_ensemble2_simple_sample_oof_0.989687_0.002561.csv'
]

rank_avg(val_pred_list, save_name='lstm_logreg_napture', weights=[8.64, 1.5, 1.9])

# test
test_pred_list = [
'rank_ensemble1_simple_lstm_test.csv',
'rank_ensemble1_simple_logreg_test.csv',
'rank_ensemble2_simple_sample_test.csv',

]

rank_avg(test_pred_list, save_name='lstm_logreg_napture', weights=[8.64, 1.5, 1.9], pred_type='test')
...
rank_avg(test_pred_list, save_name='lstm_logreg_napture', weights=[1, 1], pred_type='test')
